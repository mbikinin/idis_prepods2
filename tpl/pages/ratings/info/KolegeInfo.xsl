...
<xsl:stylesheet version="1.0"
                ...
                <table class="result_i rating_info_table">
                    <thead>
                        <tr class="row0">
                            ...
                            <td class="column5 style11 s style13" colspan="4">Заочная форма обучения</td>
                        </tr>
                        <tr class="row1">
                            ...
                            <td class="column5 style16 s style14" colspan="2">Контрольные цифры приема (бюджет)</td>
                            <td class="column7 style14 s style15" colspan="2">Места по договорам об оказании платных образовательных услуг (внебюджет)</td>
                        </tr>
                        <tr class="row2">
                            ...
                            <td class="column5 style8 s">на базе основного общего образования</td>
                            <td class="column6 style4 s">на базе среднего общего образования</td>
                            <td class="column7 style4 s">на базе основного общего образования</td>
                            <td class="column8 style5 s">на базе среднего общего образования</td>
                        </tr>
                    </thead>
    ...
    <xsl:template match="InfoRatingList/item">
        <tr>
            ...
            <td class="column5 style9 n">0</td>
            <td class="column6 style6 n">0</td>
            <td class="column7 style6 s"><xsl:value-of select="number9Z" /></td>
            <td class="column8 style7 s"><xsl:value-of select="number11Z" /></td>
        </tr>
    </xsl:template>
</xsl:stylesheet>
